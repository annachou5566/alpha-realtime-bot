...
function hardenCompetitionConfigSignalSource(input) {
    ...
    const setup = [
        ...
        "        const accumulatedTotal = waveFiniteLiveNumber(live.totalAccumulated);",
        "        const accumulatedLimit = waveFiniteLiveNumber(live.limitAccumulated);",
        ...
        "        if (accumulatedTotal !== null) item.accumulatedTotal = accumulatedTotal;",
        "        if (accumulatedLimit !== null) item.accumulatedLimit = accumulatedLimit;",
        "        if (accumulatedTotal !== null && accumulatedLimit !== null) {",
